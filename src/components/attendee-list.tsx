    ...
    return (
        <div className='flex flex-col gap-4'>
            ...
            <div className="px-3 py-1.5 border border-white/10 bg-transparent rounded-lg text-sm w-72 flex items-center gap-3" >
                ...
                <input className="bg-transparent flex-1 outline-none border-0" placeholder="Buscar participante..." />
            </div>
            </div>
                    ...
                    {Array.from({ length: 6}).map((_, i) => {
                        ...
                        <td className='py-3 px-4 text-sm text-zinc-300'>
                            <div className='flex flex-col gap-1'>
                                <span className='font-semibold text-white'>Lucas de Souza Rosa</span>
                                <span>lucas.rosa@gmail.com</span>
                            </div>
                        </td>
                        <td className='py-3 px-4 text-sm text-zinc-300'>7 dias atrás</td>
                        <td className='py-3 px-4 text-sm text-zinc-300'>Uma hora atrás</td>
                        <td className='py-3 px-4 text-sm text-zinc-300'>
